...
for (const capability of ['registerLayer','renderAt','selectMoonLandmark','setOrbit','setRegion','setSimulationTime','predictOrbit','ingestEvent','applyStoryCamera','drawHeatmap','drawClusters','drawUrbanInset','renderPlaceDetail','STORY_SCENES','orbitPeriodSeconds','gravityAt','convergenceSourcesTrigger']) {
